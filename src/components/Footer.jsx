  ...
  return (
    <footer className="bg-primary text-text py-10">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Colonna 1 - Brand */}
        <div>
          <h2 className="text-2xl font-bold mb-3 text-accent">LAST COIN</h2>
          <p className="text-sm text-gray-400 italic mb-3">
            Dove ogni partita, può essere l'ultima chance.
          </p>
        ...
        {/* Colonna 3 - Social */}
        <div>
          <h3 className="text-lg font-semibold mb-3">Seguimi su: </h3>
          <div className="flex space-x-4">
            <a
              href="https://www.linkedin.com/in/claudio-inglese-19b31135b/"
              target="_blank"
      ...
      <div className="mt-10 border-t border-tertiary pt-6 text-center text-sm text-gray-400">
        © {new Date().getFullYear()} LAST COIN - Claudio Amato Inglese - Junior Full-stack developer, Junior ReactJS - Tutti i diritti sono riservarti.
      </div>
    </footer>
  );
}
