...
export default function DropdownList({ type }) {
  ...
  const endpoints = {
    genres:
      "https://api.rawg.io/api/genres?key=6b021faf1d94421ca5d3d11e605b45d6",
    platforms:
      "https://api.rawg.io/api/platforms?key=6b021faf1d94421ca5d3d11e605b45d6",
    developers:
      "https://api.rawg.io/api/developers?key=6b021faf1d94421ca5d3d11e605b45d6",
    publishers:
      "https://api.rawg.io/api/publishers?key=6b021faf1d94421ca5d3d11e605b45d6",
    tags: "https://api.rawg.io/api/tags?key=6b021faf1d94421ca5d3d11e605b45d6",
  };
